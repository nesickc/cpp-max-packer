...
| [T-006 physical AABB baseline](T-006.md) | `feature/AT-10-aabb-baseline` | In progress from merged T-005; exact physical fixtures and retained incumbent; reuse independent correlation test oracle |
